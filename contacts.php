            ...
            <div class="contacts-items">
                <div class="info">
                    <ul>
                        ...
                        <li><span class="location-on"></span>Космос мкр. 9а, с 9:00 до 21:00<p>Как найти: Вход с торца дома, с левой стороны от<br> магазина "Пятерочка"</p>
                        <img src="img/map1.png" alt="" width="95%">
                        </li>
                        <li><span class="location-on"></span>проспект Комсомольский 73а, c 9:00 до 21:00<p>Как найти: Вход с торца дома, с левой стороны от<br> магазина "Пятерочка"<p>
                        <img src="img/map1.png" alt="" width="95%">
                        </li>
